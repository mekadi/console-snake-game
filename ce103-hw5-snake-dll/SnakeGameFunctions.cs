...
namespace ce103_hw5_snake_dll
{
    ...
    public class SnakeGameFunctions
    {
        ...
        **/
        ...
        //public void changeDirection(int[,] snakeBodyCoord, int lengthOfSnake)
        //{
        //    if (!Console.KeyAvailable)
        //    {
        //        ConsoleKey key = Console.ReadKey(false).Key;
        //        Direction currentDirection = getDirection(key);
        //        switch (key)
        //        {
        //            case ConsoleKey.UpArrow:
        //                {
        ...
        //                    //{
        //                    //    snakeBodyCoord[0, i + 1] = snakeBodyCoord[0, i];
        //                    //    snakeBodyCoord[1, i + 1] = --snakeBodyCoord[1, i];
        //                    //}
        //                    moveSnakeBody(lengthOfSnake, snakeBodyCoord, currentDirection);
        //                    break;
        //                }
        //            case ConsoleKey.DownArrow:
        //                {
        ...
        //    {
        //        Console.SetCursorPosition(snakeBodyCoord[0, i], snakeBodyCoord[1, i]);
        //        Console.Write("o");
        //    }
        //    Console.SetCursorPosition(snakeBodyCoord[0, i], snakeBodyCoord[1, i]);
        //    Console.Write('0');
        ...
        //public void prepareSnakeBody(int lengthOfSnake, int[,] snakeBodyCoord)
        //{
        //    for (int i = 0; i < lengthOfSnake; i++)
        //    {
        //        Console.SetCursorPosition(snakeBodyCoord[0, i], snakeBodyCoord[1, i]);
        ...
        //public void prepareSnakeArray(int lengthOfSnake, int[,] snakeBodyCoord)
        //{
        //    for (int i = 1; i < lengthOfSnake; i++)
        //    {
        //        snakeBodyCoord[0, i] = snakeBodyCoord[0, 0] + i;
        //        snakeBodyCoord[1, i] = snakeBodyCoord[1, 0];
        //    }
        ...
        //    switch (key)
        //    {
        //        case ConsoleKey.UpArrow: currentDirection = Direction.Up; return Direction.Up;
        //        case ConsoleKey.DownArrow: currentDirection = Direction.Down; return Direction.Down;
        //        case ConsoleKey.RightArrow: currentDirection = Direction.Right; return Direction.Right;
        //        case ConsoleKey.LeftArrow: currentDirection = Direction.Left; return Direction.Left;
        //    }
